                      ...
                      parameters& param)
{
    ...
    param.k3 = static_cast<double>(n["k3"]);
    param.k4 = static_cast<double>(n["k4"]);
    param.k5 = static_cast<double>(n["k5"]);
    param.mu = static_cast<double>(n["mu"]);
    param.mv = static_cast<double>(n["mv"]);
...
bool loadIntrinsicFromYAML(const std::string filename, sensor_msgs::CameraInfo &info_cam, parameters& param)
{
   ...
   info_cam.D.push_back(param.k3);//k2
   info_cam.D.push_back(param.k4);//k3
